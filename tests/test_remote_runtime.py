...
""",
    ...
    def test_health_rejects_each_inference_execution_failure(self):
        cases = (
            ...
            ("missing-size", {"STACK_FAKE_LLM_PS_RESPONSE": '{"models":[{"name":"gemma4:e4b","size_vram":1024}]}'}),
            ("malformed-size", {"STACK_FAKE_LLM_PS_RESPONSE": '{"models":[{"name":"gemma4:e4b","size":"1024","size_vram":1024}]}'}),
            ("malformed-vram", {"STACK_FAKE_LLM_PS_RESPONSE": '{"models":[{"name":"gemma4:e4b","size":1024,"size_vram":"1024"}]}'}),
            ("zero-size", {"STACK_FAKE_LLM_PS_RESPONSE": '{"models":[{"name":"gemma4:e4b","size":0,"size_vram":1024}]}'}),
            ("partial-vram", {"STACK_FAKE_LLM_PS_RESPONSE": '{"models":[{"name":"gemma4:e4b","size":1024,"size_vram":512}]}'}),
            ("duplicate-approved-model", {"STACK_FAKE_LLM_PS_RESPONSE": '{"models":[{"name":"gemma4:e4b","size":1024,"size_vram":1024},{"model":"gemma4:e4b","size":1024,"size_vram":1024}]}'}),
